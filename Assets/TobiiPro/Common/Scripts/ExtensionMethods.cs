...
namespace Tobii.Research.Unity
{
    internal static class TobiiExtensionMethods
    {
        ...
        {
            file.WriteStartElement("OriginalGaze");
            file.WriteAttributeString("DeviceTimeStampUS_SDK", originalGaze.DeviceTimeStamp.ToString());
            file.WriteAttributeString("SystemTimeStampUS_SDK", originalGaze.SystemTimeStamp.ToString());
