...
namespace Tobii.Research.Unity
{
    ...
    public static class IGazeDataHelper
    {
        public static double GetTimestampMS(this IGazeData gazeData)
        {
            if (gazeData == null) return 0;

            return gazeData.TimeStamp / (double)1000;
        }
    }
}
